...
## Corpus Check
- 377 files · ~3,138,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3237 nodes · 6404 edges · 78 communities detected
...
Cohesion: 0.01
Nodes (577): absoluteStoragePath(), actionToPtyData(), add(), addDependency(), addDirectory(), addPlanAttachment(), addProjectDir(), addSession() (+569 more)
...
Cohesion: 0.02
Nodes (132): autoResumeSessions(), bootstrap(), clamp(), cleanupRendererSession(), doCloseSession(), doSpawn(), doSpawnShell(), findProjectForPath() (+124 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (124): useEscProtection(), useModalStack(), useNavigation(), handleDraftEditorButton(), isDraftEditorVisible(), showDraftEditor(), hideEditorPopup(), handleBindingEditorButton() (+116 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (97): createSortControl(), asElement(), getActiveInputContext(), getEditableOwner(), getTerminalOwner(), isEditableElement(), isEditableElementInContainer(), isEditableTargetFromEvent() (+89 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (36): clearStartupFallbackTimer(), closeSplashWindow(), createSplashWindow(), createWindow(), maybeShowMainWindow(), readWindowBounds(), resolveSplashLogoUrl(), buildSplashHtml() (+28 more)
