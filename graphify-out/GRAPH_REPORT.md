...
## Corpus Check
- 407 files · ~3,144,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3358 nodes · 6727 edges · 81 communities detected
...
Cohesion: 0.01
Nodes (177): createRouter(), createController(), autoResumeSessions(), bootstrap(), clamp(), cleanupRendererSession(), doCloseSession(), doSpawn() (+169 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (121): useEscProtection(), hideEditorPopup(), handleCloseConfirmButton(), hideCloseConfirm(), showCloseConfirm(), handleDraftActionButton(), handleDraftSubmenuButton(), isDraftActionVisible() (+113 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (75): createSortControl(), focusFirstInvalidField(), getFieldError(), onSave(), revalidateField(), revalidateFieldByKey(), setFieldValue(), validateForm() (+67 more)
...
- **Thin community `Community 66`** (6 nodes): `clampHeight()`, `focus()`, `onResizeMove()`, `startResize()`, `stopResize()`, `PromptTextarea.vue`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (6 nodes): `HelmProjectService`, `.addProjectDir()`, `.constructor()`, `.listProjectDirs()`, `.listProjects()`, `.removeProjectDir()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (6 nodes): `HelmSessionPlanService`, `.constructor()`, `.findSession()`, `.resolvePlanRef()`, `.setWorkingPlan()`, `normalizeDirectoryPath()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
