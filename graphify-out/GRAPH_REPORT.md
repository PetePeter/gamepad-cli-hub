...
## Corpus Check
- 385 files · ~3,151,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3270 nodes · 6462 edges · 80 communities detected
...
Cohesion: 0.01
Nodes (189): createSortControl(), autoResumeSessions(), bootstrap(), clamp(), cleanupRendererSession(), doCloseSession(), doSpawn(), doSpawnShell() (+181 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (97): resolveEnvWithMode(), setupConfigHandlers(), setupDraftHandlers(), setupEditorHandlers(), registerIPCHandlers(), setupAppHandlers(), setupConfigHandlers(), setupGamepadHandlers() (+89 more)
