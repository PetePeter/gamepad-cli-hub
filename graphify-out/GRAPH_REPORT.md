...
## Corpus Check
- 393 files · ~3,141,134 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3322 nodes · 6642 edges · 79 communities detected
...
Cohesion: 0.01
Nodes (131): resolveEnvWithMode(), clearStartupFallbackTimer(), closeSplashWindow(), createSplashWindow(), createWindow(), maybeShowMainWindow(), readWindowBounds(), resolveSplashLogoUrl() (+123 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (135): autoResumeSessions(), bootstrap(), clamp(), cleanupRendererSession(), doCloseSession(), doSpawn(), doSpawnShell(), findProjectForPath() (+127 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (88): createSortControl(), useEscProtection(), useModalStack(), useNavigation(), handleDraftEditorButton(), isDraftEditorVisible(), showDraftEditor(), addEditorHistoryEntry() (+80 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (102): hidePlanDeleteConfirm(), ensureOverlay(), hidePlanHelpModal(), isPlanHelpVisible(), showPlanHelpModal(), applySequenceBandLayout(), assignCoordinates(), assignLayers() (+94 more)
...
- **Thin community `Community 143`** (1 nodes): `Modal Guard Regression Fixes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `Persisted Sessions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
