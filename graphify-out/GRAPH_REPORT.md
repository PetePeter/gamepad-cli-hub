...
## Corpus Check
- 405 files · ~3,144,050 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3354 nodes · 6718 edges · 78 communities detected
...
Cohesion: 0.01
Nodes (133): resolveEnvWithMode(), clearStartupFallbackTimer(), closeSplashWindow(), createSplashWindow(), createWindow(), maybeShowMainWindow(), readWindowBounds(), resolveSplashLogoUrl() (+125 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (186): createRouter(), createController(), autoResumeSessions(), bootstrap(), clamp(), cleanupRendererSession(), doCloseSession(), doSpawn() (+178 more)
...
Cohesion: 0.04
Nodes (59): editOriginalMessage(), expandSequence(), findSequenceByLabel(), flattenSequences(), handleAccept(), handleCancel(), handleCloseAll(), handleCommandExec() (+51 more)
...
Cohesion: 0.05
Nodes (61): createSortControl(), addEditorHistoryEntry(), getScopedEntries(), loadEditorHistory(), safeParseHistory(), saveEditorHistory(), sortBindingEntries(), showFormModal() (+53 more)
...
Cohesion: 0.06
Nodes (23): actionToPtyData(), comboToPtySequence(), executeSequenceString(), keyToPtySequence(), appendText(), canonicalizeKey(), canonicalizeModifier(), formatAction() (+15 more)
...
Cohesion: 0.14
Nodes (20): isEditableElementInsideModal(), asElement(), getActiveInputContext(), getEditableOwner(), getTerminalOwner(), isEditableElement(), isEditableElementInContainer(), isEditableTargetFromEvent() (+12 more)
