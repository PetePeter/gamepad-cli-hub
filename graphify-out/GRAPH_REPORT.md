...
## Corpus Check
- 392 files · ~3,140,795 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3319 nodes · 6636 edges · 80 communities detected
...
Cohesion: 0.01
Nodes (124): resolveEnvWithMode(), buildAgentPlanGuide(), buildAiagentStateGuide(), getAiagentStates(), buildNotificationGuide(), getAvailableDirectories(), getAvailableProjects(), getSessionInfo() (+116 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (146): autoResumeSessions(), bootstrap(), clamp(), cleanupRendererSession(), doCloseSession(), doSpawn(), doSpawnShell(), findProjectForPath() (+138 more)
...
Cohesion: 0.03
Nodes (77): createSortControl(), addEditorHistoryEntry(), getScopedEntries(), loadEditorHistory(), safeParseHistory(), saveEditorHistory(), showContextMenu(), sortBindingEntries() (+69 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (49): handleDraftEditorButton(), isDraftEditorVisible(), showDraftEditor(), asElement(), getActiveInputContext(), getEditableOwner(), getTerminalOwner(), isEditableElement() (+41 more)
...
Cohesion: 0.05
Nodes (12): useEscProtection(), hideEditorPopup(), handleSequencePickerButton(), hideSequencePicker(), showSequencePicker(), closeQuickSpawn(), getEditorPopupResolve(), isAnyBridgeModalVisible() (+4 more)
...
- **Thin community `Community 53`** (11 nodes): `draft-manager.js`, `DraftManager`, `.clearSession()`, `.count()`, `.create()`, `.delete()`, `.exportAll()`, `.get()`, `.getForSession()`, `.importAll()`, `.update()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (11 nodes): `ProjectStore`, `.addDirectory()`, `.constructor()`, `.delete()`, `.getById()`, `.isDirty()`, `.list()`, `.removeDirectory()`, `.rename()`, `.requireRecord()`, `.save()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
