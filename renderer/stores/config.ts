...
export const useConfigStore = defineStore('config', () => {
  ...
  function getToolConfig(cliType: string): { pasteMode?: 'pty' | 'ptyindividual' | 'sendkeys' | 'sendkeysindividual'; [k: string]: any } {
  ...
  function setToolsCache(cache: Record<string, { pasteMode?: 'pty' | 'ptyindividual' | 'sendkeys' | 'sendkeysindividual'; [k: string]: any }>) {
