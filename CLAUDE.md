...
9. **AI-authored content is untrusted** — anything an AI produces that gets rendered is sanitized before display, and remote peers act under a synthetic proxy identity that can never impersonate a local session.
