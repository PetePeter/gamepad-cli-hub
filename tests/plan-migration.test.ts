...
describe('migrateOldPlans (real I/O)', () => {
  ...
  it('converts plans.yaml to individual plan files', () => {
    writeTestPlansYaml(tmpDir, {
      '/proj': {
        dirPath: '/proj',
        items: [
          { id: 'aaaa0001-0000-0000-0000-000000000001', dirPath: '/proj', title: 'Task A', description: 'Desc A', status: 'ready', createdAt: 100, updatedAt: 101 },
          { id: 'aaaa0002-0000-0000-0000-000000000002', dirPath: '/proj', title: 'Task B', description: 'Desc B', status: 'planning', createdAt: 200, updatedAt: 201 },
        ],
        dependencies: [],
      },
    });
  ...
  it('preserves all plan item fields after migration', () => {
    const item = { id: 'aaaa0001-0000-0000-0000-000000000001', dirPath: '/proj', title: 'Auth', description: 'JWT', status: 'ready' as const, createdAt: 100, updatedAt: 101 };
  ...
  it('preserves dependency edges', () => {
    writeTestPlansYaml(tmpDir, {
      '/proj': {
        dirPath: '/proj',
        items: [
          { id: 'aaaa0001-0000-0000-0000-000000000001', dirPath: '/proj', title: 'A', description: '', status: 'ready', createdAt: 1, updatedAt: 1 },
          { id: 'aaaa0002-0000-0000-0000-000000000002', dirPath: '/proj', title: 'B', description: '', status: 'planning', createdAt: 2, updatedAt: 2 },
        ],
  ...
  it('returns correct counts for multiple directories', () => {
    writeTestPlansYaml(tmpDir, {
      '/a': { dirPath: '/a', items: [
        { id: 'aaaa0001-0000-0000-0000-000000000001', dirPath: '/a', title: 'X', description: '', status: 'ready', createdAt: 1, updatedAt: 1 },
      ], dependencies: [] },
      '/b': { dirPath: '/b', items: [
        { id: 'aaaa0002-0000-0000-0000-000000000002', dirPath: '/b', title: 'Y', description: '', status: 'ready', createdAt: 1, updatedAt: 1 },
        { id: 'aaaa0003-0000-0000-0000-000000000003', dirPath: '/b', title: 'Z', description: '', status: 'planning', createdAt: 1, updatedAt: 1 },
