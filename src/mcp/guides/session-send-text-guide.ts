...
export function buildSessionSendTextGuide() {
  return {
    ...
    inter_llm_handoff_protocol: [
      'Call session_send_text(sessionId, text, senderSessionId) with submit=true (default).',
    ...
    optional_args: { submit: 'Boolean, default true', expectsResponse: 'Boolean, default false. True = reply auto-pastes to your session' },
    examples: [
