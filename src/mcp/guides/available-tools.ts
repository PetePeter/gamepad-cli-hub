...
export function getAvailableTools(): McpToolSummary[] {
  return [
    ...
    { name: 'sequence_list', title: 'List Sequences', description: 'List sequence/shared-memory stores for a directory or plan, including member plan IDs and sharedMemory.' },
    { name: 'sequence_get', title: 'Get Sequence', description: 'Get one sequence/shared-memory store by ID, including member plan IDs and sharedMemory.' },
    { name: 'sequence_create', title: 'Create Sequence', description: 'Create a sequence/shared-memory store that plans can join.' },
    { name: 'sequence_update', title: 'Update Sequence', description: 'Update sequence title, mission, sharedMemory, or order. Pass expectedUpdatedAt for mutex-style write protection.' },
    { name: 'sequence_memory_append', title: 'Append Sequence Memory', description: 'Append to a sequence sharedMemory store with optional expectedUpdatedAt concurrency protection.' },
