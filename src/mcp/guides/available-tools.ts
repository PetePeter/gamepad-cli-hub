...
export function getAvailableTools(): McpToolSummary[] {
  return [
    ...
    { name: 'session_info', title: 'Get Session Info', description: 'Retrieve MCP endpoint, AIAGENT state registry, available tools, directories, and agent planning guidance, including durable context/tooling reminders. Call this at session startup before other Helm workflow actions.' },
